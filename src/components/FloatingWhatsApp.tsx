...
const FloatingWhatsApp = () => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-40 btn-primary rounded-full p-3 sm:p-4 shadow-lg hover:shadow-xl transition-all duration-300 ${
